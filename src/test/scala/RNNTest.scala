...
// 		val f = new File("/Users/jamestillman/Documents/prog/scala/agi/src/test/scala/toBePainted.jpg")
...
// 		val w1 = new VariableMtx("w1", (Option(2), Option(65)), mf.normal(0.1))
// 		val b1 = new VariableMtx("b1", (Option(1), Option(65)), mf.normal(0.1))
// 		val z1 = new Add("z1", b1, new Mult("z11", a, w1))
// 		val a1 = new Transform("a1", z1, funcs.LeakyRelu)

// 		val w2 = new VariableMtx("w2", (Option(65), Option(65)), mf.normal(0.1))
// 		val b2 = new VariableMtx("b2", (Option(1), Option(65)), mf.normal(0.1))
// 		val z2 = new Add("z2", b2, new Mult("z22", a1, w2))
// 		val a2 = new Transform("a2", z2, funcs.LeakyRelu)

// 		val w3 = new VariableMtx("w3", (Option(65), Option(65)), mf.normal(0.1))
// 		val b3 = new VariableMtx("b3", (Option(1), Option(65)), mf.normal(0.1))
// 		val z3 = new Add("z3", b3, new Mult("z33", a2, w3))
// 		val a3 = new Transform("a3", z3, funcs.LeakyRelu)

// 		val w33 = new VariableMtx("w3", (Option(65), Option(65)), mf.normal(0.1))
// 		val b33 = new VariableMtx("b3", (Option(1), Option(65)), mf.normal(0.1))
// 		val z33 = new Add("z3", b33, new Mult("z33", a3, w33))
// 		val a33 = new Transform("a3", z33, funcs.LeakyRelu)

// 		val w4 = new VariableMtx("w4", (Option(65), Option(65)), mf.normal(0.1))
// 		val b4 = new VariableMtx("b4", (Option(1), Option(65)), mf.normal(0.1))
// 		val z4 = new Add("z4", b2, new Mult("z44", a33, w4))
// 		val a4 = new Transform("a4", z4, funcs.LeakyRelu)

// 		val w5 = new VariableMtx("w5", (Option(65), Option(1)), mf.normal(0.1))
...
// 			loss.adjust(0.003)
// 			if(x % 5000 == 0){
// 				lastLoss = avLoss / 5000
// 				println(x + " of 5000000: " + avLoss / 100)
// 				avLoss = 0
// 			}
...
// 		ImageIO.write(out, "png", new File("/Users/jamestillman/Documents/prog/scala/agi/src/test/scala/test.png"))
// 	}
